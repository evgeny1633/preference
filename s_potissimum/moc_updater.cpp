...
QT_MOC_LITERAL(5, 55, 11)
    ...
    "Updater\0send_message_signal\0\0message\0"
    "send_message_slot\0new_message\0"
};
...
void Updater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->send_message_signal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->send_message_slot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Updater::send_message_signal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Updater::send_message_signal(QString _t1)
{
